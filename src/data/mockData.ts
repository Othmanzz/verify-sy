...
export const mockFactChecks: FactCheck[] = [
  ...
  {
    id: '8',
    title: 'تحقق معتمد من IFCN: معلومة مريكة وغير واضحة ونحتاج لمزيد من التحقق',
    summary: 'هذه المعلومة مريكة وغير واضحة ونحتاج لمزيد من التحقق وفقاً لمعايير التحقق الدولية التي تعتمد على مصادر علمية معتبرة. تم الاعتماد على مصادر علمية معتبرة.',
    verdict: 'confirmed',
