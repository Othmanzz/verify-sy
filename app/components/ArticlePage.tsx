...
export default function ArticlePage({ article }: ArticlePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/50" dir="rtl">
      {/* Regular Header (Non-sticky) - Mobile Responsive */}
      <div className="bg-white border-b border-gray-200/50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-lg sm:rounded-xl flex items-center justify-center shadow-sm">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
              </div>
              <div>
                <h1 className="text-base sm:text-lg font-bold text-gray-900 font-arabic-heading">تحقق من المعلومة</h1>
                <p className="text-xs sm:text-sm text-gray-500 font-arabic">{article.category}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:hidden gap-2 w-full">
              <div className="flex items-center gap-2">
                <button 
                  onClick={() => router.push('/')}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 font-arabic font-medium text-sm border border-gray-200"
                >
                ...
                <button 
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-all duration-200 font-arabic font-medium text-sm shadow-md hover:shadow-lg"
                >
            ...
            {/* Desktop: Back to Search Button */}
            <button 
              onClick={() => router.push('/search')}
              className="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition-all duration-200 font-arabic font-medium text-sm shadow-md hover:shadow-lg"
            >
              <Database className="w-4 h-4" />
              العودة للبحث
            </button>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Compact Hero Section - Mobile Responsive */}
          <div id="overview" className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden mb-4 sm:mb-6" data-hero-section>
            {/* Enhanced Header with Better Typography - Mobile Responsive */}
            <div className={`${verdictConfig.headerBg} text-white px-4 sm:px-6 py-4 sm:py-6 text-center relative overflow-hidden`}>
              ...
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 mb-3">
                  ...
                  <div className="bg-white/15 backdrop-blur-sm rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 border border-white/20">
                    <VerdictBadge verdict={article.verdict} size="sm" />
                  </div>
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2 sm:px-3 py-1">
                    <Shield className="w-3 h-3" />
                    <span className="font-arabic font-medium text-xs sm:text-sm">IFCN معتمد</span>
                  </div>
                </div>
                
                {/* Enhanced Title with Better Contrast - Mobile Responsive */}
                <div className="bg-black/20 backdrop-blur-sm rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3 sm:py-4 border border-white/20">
                  <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black font-arabic-heading leading-tight text-white drop-shadow-lg">
                    {article.title}
                  </h2>
                </div>
              </div>
            ...
            {/* Compact Content Section - Mobile Responsive */}
            <div className="p-4 sm:p-6">
              <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 items-start">
                ...
                <div className="lg:col-span-1">
                  <div className="relative group">
                    <img 
                      src={article.image}
                      alt={article.title}
                      className="w-full h-40 sm:h-48 object-cover rounded-lg sm:rounded-xl shadow-md border border-gray-200/50 group-hover:shadow-lg transition-all duration-300"
                    />
                    {/* Compact Category Badge */}
                    <div className="absolute top-2 sm:top-3 right-2 sm:right-3">
                      <span className="bg-white/90 backdrop-blur-sm text-gray-800 px-2 sm:px-3 py-1 rounded-full text-xs font-bold shadow-md font-arabic">
                        {article.category}
                      </span>
                    </div>
                  </div>
                ...
                {/* Summary and Meta - Mobile Responsive */}
                <div className="lg:col-span-2 space-y-3 sm:space-y-4">
                  <p className="text-base sm:text-lg text-gray-600 font-arabic leading-relaxed">
                    {article.summary}
                  </p>
                  
                  {/* Compact Meta Information - Mobile Responsive */}
                  ...
                  {/* Inline Social Sharing - Mobile Responsive */}
          ...
          {/* Two-Column Layout for Desktop - Mobile Responsive */}
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Main Content Column - Mobile Responsive */}
            <div className="lg:col-span-2 space-y-4">
              
              {/* Article Content - Enhanced with Full Content - Mobile Responsive */}
              <div id="details" className="bg-white rounded-xl shadow-md p-4 sm:p-6">
                <h2 className="text-xl sm:text-2xl font-black mb-4 sm:mb-6 font-arabic-heading text-gray-900">تفاصيل التحقق</h2>
              ...
              {/* Related Articles Section - Mobile Responsive */}
              {relatedArticles.length > 0 && (
                <div className="bg-white rounded-xl shadow-md p-4 sm:p-6">
                  <h2 className="text-xl sm:text-2xl font-black mb-4 sm:mb-6 font-arabic-heading text-gray-900">مقالات ذات صلة</h2>
                  <div className="grid gap-3 sm:gap-4">
                    {relatedArticles.map((relatedArticle) => (
                      <div 
                        key={relatedArticle.id}
                        className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-blue-300 hover:shadow-md transition-all duration-200 cursor-pointer"
                      ...
                      >
                        <div className="flex gap-3 sm:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-gray-900 font-arabic-heading mb-2 line-clamp-2 text-sm sm:text-base">
                              {relatedArticle.title}
                            </h3>
                            <p className="text-xs sm:text-sm text-gray-600 font-arabic line-clamp-2 mb-2">
            ...
            {/* Sidebar Column - Mobile Responsive */}
            <div className="lg:col-span-1 space-y-3 sm:space-y-4">
              
              {/* Audio Player in Sidebar - Mobile Responsive */}
              ...
              {/* Compact Verdict Analysis - Mobile Responsive */}
              <div id="analysis" className={`${verdictConfig.bg} ${verdictConfig.border} border rounded-xl overflow-hidden shadow-md`}>
                <div className="p-3 sm:p-4">
                  <h3 className="text-base sm:text-lg font-black mb-3 font-arabic-heading text-gray-900 flex items-center gap-2">
                    <verdictConfig.icon className={`w-5 h-5 sm:w-6 sm:h-6 ${verdictConfig.iconColor}`} />
                    تحليل التحقق
                  </h3>
                  <p className="text-xs sm:text-sm leading-relaxed font-arabic text-gray-700 mb-3 sm:mb-4">
                    {verdictConfig.description}
                  </p>
                  
                  {/* Sub-verdict section - Mobile Responsive */}
                  {article.subVerdict && (
                    <div className="bg-white/90 backdrop-blur-sm rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 border border-gray-200/50">
                      <div className="flex items-start gap-2 sm:gap-3">
                        <Info className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 mt-1 flex-shrink-0" />
                        <div className="flex-1 min-w-0">
                          <h4 className="font-bold text-gray-900 font-arabic-heading text-xs sm:text-sm mb-2">
                            {article.subVerdict}
                          </h4>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                      <Award className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mb-2" />
                      <div className="font-bold text-gray-900 font-arabic-heading text-xs sm:text-sm">مصادر موثقة</div>
                      <div className="text-xs text-gray-600 font-arabic">مصادر علمية معتبرة</div>
                    </div>
                    <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                      <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mb-2" />
                      <div className="font-bold text-gray-900 font-arabic-heading text-xs sm:text-sm">معايير دولية</div>
                      <div className="text-xs text-gray-600 font-arabic">معايير التحقق الدولية</div>
                    </div>
                    <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 mb-2" />
                      <div className="font-bold text-gray-900 font-arabic-heading text-xs sm:text-sm">مراجع متخصص</div>
              ...
              {/* Sources Section - Enhanced - Mobile Responsive */}
              {articleContent?.sources && (
                <div className="bg-white rounded-xl shadow-md p-3 sm:p-4">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-base sm:text-lg font-bold font-arabic-heading text-gray-900">المصادر</h3>
                  </div>
                  <div className="space-y-2 sm:space-y-3">
                    {articleContent.sources.map((source) => (
                      <div key={source.id} className="bg-gray-50 rounded-lg p-2 sm:p-3">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-bold text-gray-900 font-arabic-heading text-xs sm:text-sm mb-1">
                              {source.title}
                            </h4>
              ...
              {/* Compact Tags Section - Mobile Responsive */}
              <div className="bg-white rounded-xl shadow-md p-3 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-indigo-100 rounded-lg flex items-center justify-center">
                    <span className="text-indigo-600 font-black text-xs sm:text-sm">#</span>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold font-arabic-heading text-gray-900">العلامات</h3>
                </div>
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {article.tags.map((tag: string, index: number) => (
                    <span key={index} className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-2 sm:px-3 py-1 rounded-lg font-arabic font-medium text-xs sm:text-sm shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer">
                      #{tag}
                    </span>
                  ))}
                </div>
