              ...
              <div className="bg-white rounded-3xl p-10 shadow-2xl border border-gray-100">
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed font-arabic">
                  <div className="flex items-start gap-4">
                    ...
                    <p>
                      بدأت قصة "تأكد" في مارس 2011 كموقع إخباري باسم "شو الأخبار" يسعى لكشف الحقيقة حول الأحداث في سوريا. 
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <p>
                      في يناير 2014، نشرنا أول مقال لمواجهة دعاية داعش. وفي 2016، أطلقنا كصفحة فيسبوك باسم "منصة تحقق"، 
